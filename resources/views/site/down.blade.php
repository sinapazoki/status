      ...
      <div class="w-full">
        <div class="w-full pb-6 sm:pr-5 lg:pr-0 md:pb-0">
          ...
          <h2 class="text-2xl sm:text-3xl tracking-tight text-gray-900 -mb-4 font-bold flex items-center flex-col text-center sm:flex-row">
            ...
            <p class="block xl:inline">برخی از سرویس ها دچار<span class=" text-red-600 xl:inline " data-primary="indigo-600"> اختلال </span> هستند</p>
          </h2>
            ...
            <div class="relative mx-auto max-w-7xl " style="cursor: auto;">
              <div class="max-w-lg mx-auto overflow-hidden rounded-lg shadow-lg lg:max-w-none lg:flex">
                <div class="flex-1 px-4 py-3 bg-white lg:p-6" style="cursor: auto;">
                  <h3 class="text-xl text-gray-900 sm:text-xl" style="cursor: auto;">license | انقضای لایسنس دایرکت ادمین سرور lh420</h3>
                  ...
                  <div class="mt-8">
                    <div class="flex items-center">
                      ...
                      <a href="/success" class="flex-shrink-0 pr-4 text-sm font-semibold tracking-wider text-indigo-600 uppercase bg-white">مشاهده جزئیات بیشتر</a>
                    </div>

                  </div>
                </div>
               
                <div class="px-4 py-8 text-center bg-gray-50 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-8" style="cursor: auto;">
                <div class="flex items-center justify-center space-x-3 space-x-reverse">
                  <span class="flex h-3 w-3 relative">
                    <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                    <span class="relative inline-flex rounded-full h-3 w-3 bg-red-500"></span>
                  </span>
                  <p class="text-red-500 font-bold">دچار بحران</p>

                </div>

                   <div class="flex items-center justify-center mt-4 text-5xl font-extrabold text-gray-600">
                    <span class="ml-3 text-sm font-medium "> تاریخ ایجاد -</span>
                    <span class="text-base">۲ مهر ۱۴۰۱</span>
                  </div>
                  <div class="flex items-center justify-center mt-4 text-5xl font-extrabold text-gray-600">
                    <span class="ml-3 text-sm font-medium ">  زمان احتمالی -</span>
                    <span class="text-base">2 ساعت</span>
                  </div>           

                  <div class="mt-6">
                    <div class="rounded-md">
                        <label   for="my-modal-3" class="shadow w-full modal-button btn btn-sm bg-blue-500 hover:bg-blue-700 border-none" > <i class="w-4 ml-2" data-feather="bell"></i>  اطلاع رسانی                           
                        </label >
                        </div>
                  </div>
          ...
          <div class="mx-auto mt-10">
            ...
            <div class="relative mx-auto max-w-7xl" style="cursor: auto;">
              <div class="max-w-lg mx-auto overflow-hidden rounded-lg shadow-lg lg:max-w-none lg:flex">
                <div class="flex-1 px-4 py-3 bg-white lg:p-6" style="cursor: auto;">
                  <h3 class="text-xl text-gray-900 sm:text-xl" style="cursor: auto;">license | انقضای لایسنس دایرکت ادمین سرور lh420</h3>
                  <p class="mt-6 text-justify text-base text-gray-500">
                    در رابطه با اختلال کنترل پنل سرور lh420: هم اکنون با توجه به منقضی شدن لایسنس کنترل پنل دایرکت ادمین سرور مذکور وباتوجه به اختلال ارتباط با سرویس های خارجی در حال رفع این مشکل هستیم.
                ...
                <div class="flex items-center justify-center space-x-3 space-x-reverse">
                  ...
                  <p class="text-orange-500 font-bold">دچار اختلال</p>
  ...
  <input type="checkbox" id="my-modal-3" class="modal-toggle" />
        <div class="modal">
          <div class="modal-box relative">
            ...
            <h3 class="text-lg font-bold text-blue-600">اطلاع رسانی رفع اختلال</h3>
            <p class="py-4">در صورت تمایل به دریافت ایمیل پس از رفع مشکل مذکور می توانید ایمیل خود را ثبت نمایید.</p>
